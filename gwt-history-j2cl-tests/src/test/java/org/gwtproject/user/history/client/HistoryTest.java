...
//                @Override
//                public void run() {
//                  addHistoryListenerImpl(event -> resolve.onInvoke((Void) null));
//                }
//              };
//          timer.schedule(500);
//        });
//  }
  ...
  //                public void run() {
  //                  addHistoryListenerImpl(
  //                      event -> resolve.onInvoke((Void) null));
  //                }
  //              };
  //          timer.schedule(500);
  //        });
  ...
  //
  //  /**
  //   * Verify that {@link ValueChangeHandler#onValueChange(ValueChangeEvent)} is only called once
  // per
  ...
  //     * Without this, History.back() might send the browser too far back, i.e. back to before the
  // web
  ...
  //
  //                state = 2;
  //                History.replaceItem(historyToken3,
  //                                    true);
  //                break;
  //              }
  //
  ...
  //
  //    History.replaceItem(historyToken2,
  //                        false);
  //    assertEquals(historyToken2,
  //                 History.getToken());
  //
  //    delayTestFinish(500);
  //
  ...
  //            assertEquals(historyToken2_encoded,
  ...
  //    String hash = DomGlobal.window.location.getHash();
  //    if (hash.isEmpty()) {
  ...
  //    addHistoryListenerImpl(
  //        event -> {
  //          assertEquals(shouldBeEncodedAs,
  //                       getCurrentLocationHash());
  //          assertEquals(shouldBeEncoded,
  //                       event.getValue());
  //          finishTest();
  //        });
  ...
  //    History.newItem("");
  //
  //    assertEquals("Expected two history events",
  //                 2,
  //                 counter.size());
  //  }
  //
