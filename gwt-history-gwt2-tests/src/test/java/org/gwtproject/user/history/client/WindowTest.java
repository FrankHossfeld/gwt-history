...
public class WindowTest extends GWTTestCase {
  ...
  public void testLocationCreateUrlBuilder() {
    ...
    String expected = Window.Location.getHref();
    ...
    // Check the query parameters.
    {
      ...
      if (expectedParts.length > 1) {
        ...
        for (String actualPair : actualPairs) {
          ...
          assertEquals(
              Window.Location.getParameter(kv[0]),
  ...
  public void testNavigator() {
    assertNotNull(Window.Navigator.getAppCodeName());
    assertNotNull(Window.Navigator.getAppName());
    assertNotNull(Window.Navigator.getAppVersion());
    assertNotNull(Window.Navigator.getPlatform());
    assertNotNull(Window.Navigator.getUserAgent());
    assertTrue(Window.Navigator.isCookieEnabled());
    ...
    // optimized away.
    try {
      Window.Navigator.isJavaEnabled();
  ...
  public void testGetClientSize() {
    ...
    if (oldClientHeight < 49 && Window.Navigator.getUserAgent().contains("Firefox")) {
      return;
    }
